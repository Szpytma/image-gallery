Image Gallery - Have an array of image urls (you can use unsplash for free images or provide your own!) and make an image gallery with buttons for displaying the next image.
